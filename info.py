...
API_ID = int(environ.get('API_ID', '26493906'))
API_HASH = environ.get('API_HASH', 'e8c040c5d682e1e7bf3a0ea52027cc60')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS','https://ar-hosting.pages.dev/1756278270084.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002582472331'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002593252074').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://surjibhartiya3232:MBeejQAfok9LeAdV@cluster0.5egguvj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://ar-hosting.pages.dev/1756280003872.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK',  'https://t.me/movisaga')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviesagclub')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviesaga') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@Surajbharti32')
